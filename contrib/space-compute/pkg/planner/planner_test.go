...
func scenario() (time.Time, *spacev1.SpaceMission, []*spacev1.SpaceDomainResourceSummary, []*spacev1.SpaceLinkSnapshot) {
	...
	mission := &spacev1.SpaceMission{ObjectMeta: metav1.ObjectMeta{Name: "earth-observation", Namespace: "missions", UID: types.UID("mission-uid"), Generation: 1}, Spec: spacev1.SpaceMissionSpec{MissionClass: "earth-observation", Priority: 900, StatePolicy: spacev1.PolicyStrict,
		...
		Inputs: []spacev1.DataObject{{ID: "sensor-frame", SizeBytes: 600_000_000, Locations: []spacev1.DataLocation{{Domain: spacev1.DomainReference{Name: "ground-a", ClusterID: "ground-a-cluster", OrbitClass: spacev1.OrbitGround}}}}}, OutputSizeBytes: 10_000_000, ResultDestinations: []spacev1.DataLocation{{Domain: spacev1.DomainReference{Name: "ground-a", ClusterID: "ground-a-cluster", OrbitClass: spacev1.OrbitGround}}}, ResultReturnRequired: true,
